"""
GUI Builder für Migration Tool
...
def build_database_section():
    ...
    # Checkbox für Collations
    step4_checkbox = QCheckBox("Collations ausführen")
...
def build_migration_steps_section():
    ...
    step1_btn = QPushButton("1️⃣ Tabellen & Daten")
    step2_btn = QPushButton("2️⃣ Verifizieren")
    step3_btn = QPushButton("3️⃣ Constraints & Indexes")
    step4_btn = QPushButton("4️⃣ Collations")
    ...
    run_all_btn = QPushButton("ALLE SCHRITTE AUSFÜHREN")
...
def build_log_section():
    ...
    type_mappings_btn = QPushButton("🔄 Datentypen bearbeiten")
    type_mappings_btn.setToolTip("Bearbeite MSSQL → PostgreSQL Datentyp-Mappings")
